...
def get_feature_opensmile(filepath: str):
    ...
    cmd = 'cd ' + Config.OPENSMILE_PATH + '\\bin\\Win32 && SMILExtract_Release -C C:\\Users\\JyunmauChan\\Downloads\\opensmile-2.3.0\\config\\IS10_paraling' + '.conf -I ' + filepath + ' -O ' + BASE_DIR + '/' + Config.FEATURE_PATH + 'single_feature.csv'
